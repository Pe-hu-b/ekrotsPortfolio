(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function n(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=n(r);fetch(r.href,s)}})();var Bx={exports:{}},ru={},kx={exports:{}},je={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var zE=Q,HE=Symbol.for("react.element"),GE=Symbol.for("react.fragment"),WE=Object.prototype.hasOwnProperty,jE=zE.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,XE={key:!0,ref:!0,__self:!0,__source:!0};function $x(t,e,n){var i,r={},s=null,o=null;n!==void 0&&(s=""+n),e.key!==void 0&&(s=""+e.key),e.ref!==void 0&&(o=e.ref);for(i in e)WE.call(e,i)&&!XE.hasOwnProperty(i)&&(r[i]=e[i]);if(t&&t.defaultProps)for(i in e=t.defaultProps,e)r[i]===void 0&&(r[i]=e[i]);return{$$typeof:HE,type:t,key:s,ref:o,props:r,_owner:jE.current}}ru.Fragment=GE;ru.jsx=$x;ru.jsxs=$x;Bx.exports=ru;var j=Bx.exports,qx={exports:{}},Dn={},Kx={exports:{}},Zx={};/**
 * @license React
...
`;function vN({scrollRef:t}){const e=Q.useRef(null),n=Q.useRef({x:0,y:0});return Q.useEffect(()=>{if(!e.current)return;const i=new QP;i.fog=new $m(0,.012);const r=new On(60,window.innerWidth/window.innerHeight,.1,1e3);r.position.z=35;const s=new pN({antialias:!jo,alpha:!0});s.setPixelRatio(Math.min(window.devicePixelRatio,jo?1:1.5)),s.setSize(window.innerWidth,window.innerHeight),s.toneMapping=Bm,s.toneMappingExposure=1.2,e.current.appendChild(s.domElement);const o=jo?60:120,a=[],l=[];for(let B=0;B<o;B++){const D=8+Math.random()*16,U=Math.random()*Math.PI*2,G=Math.acos(2*Math.random()-1),$=D*Math.sin(G)*Math.cos(U),te=D*Math.sin(G)*Math.sin(U),ne=D*Math.cos(G),ge=new Zm(.1+Math.random()*.1,6,6),Ve=new ha({color:Math.random()>.3?54527:8086015,transparent:!0,opacity:.7}),We=new Rn(ge,Ve);We.position.set($,te,ne),We.userData.phase=Math.random()*Math.PI*2,i.add(We),a.push(We),l.push(new O((Math.random()-.5)*.02,(Math.random()-.5)*.02,(Math.random()-.5)*.02))}const c=new iu(2.5,2),f=new ci({vertexShader:mN,fragmentShader:gN,uniforms:{uTime:{value:0},uColorBase:{value:new qe(35801)},uColorFresnel:{value:new qe(8086015)}},transparent:!0,blending:da,depthWrite:!1}),h=new Rn(c,f);i.add(h);const u=new iu(2.6,2),p=new ha({color:8086015,wireframe:!0,transparent:!0,opacity:.08}),g=new Rn(u,p);i.add(g);const y=new Qm(12,.04,4,80),v=new ha({color:8086015,transparent:!0,opacity:.12}),d=new Rn(y,v);d.rotation.x=Math.PI/3,i.add(d);const m=jo?200:500,x=new on,S=new Float32Array(m*3);for(let B=0;B<m*3;B+=3)S[B]=(Math.random()-.5)*80,S[B+1]=(Math.random()-.5)*80,S[B+2]=(Math.random()-.5)*80;x.setAttribute("position",new ai(S,3));const E=new aE({color:8086015,size:.07,transparent:!0,opacity:.35,blending:da}),A=new u3(x,E);i.add(A);let C=null;const _=jo?9:7;let T=0;const L=()=>{C&&i.remove(C);const B=[],D=[];for(let $=0;$<a.length;$++)for(let te=$+1;te<a.length;te++){const ne=a[$].position.distanceTo(a[te].position);if(ne<_){B.push(a[$].position.x,a[$].position.y,a[$].position.z,a[te].position.x,a[te].position.y,a[te].position.z);const ge=.1*(1-ne/_);D.push(0,.831,1,ge),D.push(0,.831,1,ge)}}const U=new on;U.setAttribute("position",new Tt(B,3)),U.setAttribute("color",new Tt(D,4));const G=new oE({vertexColors:!0,transparent:!0,blending:da});C=new c3(U,G),i.add(C)},b=B=>{n.current.x=B.clientX/window.innerWidth*2-1,n.current.y=-(B.clientY/window.innerHeight)*2+1};window.addEventListener("mousemove",b);const k=()=>{r.aspect=window.innerWidth/window.innerHeight,r.updateProjectionMatrix(),s.setSize(window.innerWidth,window.innerHeight)};window.addEventListener("resize",k);const V={x:0,y:0,z:35};let Y=0;const H=()=>{Y+=.016,T++,f.uniforms.uTime.value=Y,a.forEach((ge,Ve)=>{ge.position.add(l[Ve]),Math.abs(ge.position.x)>25&&(l[Ve].x*=-1),Math.abs(ge.position.y)>20&&(l[Ve].y*=-1),Math.abs(ge.position.z)>20&&(l[Ve].z*=-1);const We=.5+.5*Math.sin(Y*1.5+ge.userData.phase);ge.material.opacity=.4+.6*We,ge.scale.setScalar(.85+.3*We)}),T%4===0&&L(),d.rotation.z+=.004;const B=x.attributes.position.array;for(let ge=1;ge<B.length;ge+=3)B[ge]+=.0015;for(let ge=0;ge<B.length;ge+=3)B[ge]+=4e-4;x.attributes.position.needsUpdate=!0;const D=t.current,U=35-D*20,G=D*8,$=Math.sin(D*Math.PI)*5,te=n.current.x*3,ne=n.current.y*2;V.x+=($+te-V.x)*.04,V.y+=(G+ne-V.y)*.04,V.z+=(U-V.z)*.04,r.position.set(V.x,V.y,V.z),r.lookAt(0,G*.3,0),s.render(i,r),requestAnimationFrame(H)};return H(),()=>{var B;window.removeEventListener("mousemove",b),window.removeEventListener("resize",k),(B=e.current)==null||B.removeChild(s.domElement),s.dispose()}},[t]),j.jsx("div",{ref:e,className:"fixed inset-0 z-[1]"})}function xN(){const t=Q.useRef(null),e=Q.useRef(null),n=Q.useRef({x:0,y:0}),i=Q.useRef({x:0,y:0});return Q.useEffect(()=>{const r=o=>{i.current={x:o.clientX,y:o.clientY},t.current&&(t.current.style.transform=`translate(${o.clientX-3}px, ${o.clientY-3}px)`)},s=()=>{n.current.x+=(i.current.x-n.current.x)*.12,n.current.y+=(i.current.y-n.current.y)*.12,e.current&&(e.current.style.transform=`translate(${n.current.x-16}px, ${n.current.y-16}px)`),requestAnimationFrame(s)};return window.addEventListener("mousemove",r),s(),()=>{window.removeEventListener("mousemove",r)}},[]),j.jsxs(j.Fragment,{children:[j.jsx("div",{ref:t,className:"fixed top-0 left-0 w-[6px] h-[6px] rounded-full pointer-events-none z-[9999] mix-blend-difference",style:{backgroundColor:"#00D4FF",willChange:"transform"}}),j.jsx("div",{ref:e,className:"fixed top-0 left-0 w-8 h-8 rounded-full pointer-events-none z-[9999] border border-[rgba(0,212,255,0.4)]",style:{willChange:"transform"}})]})}console.log("BootSequence mounted");const td=["INITIALIZING NEURAL CORE...","LOADING QUANTUM PROCESSORS...","ESTABLISHING BLOCKCHAIN NODES...","SYNCING DISTRIBUTED SYSTEMS...","ACTIVATING PORTFOLIO INTERFACE..."];function _N({onComplete:t}){console.log("🚀 BootSequence RENDERED"),console.log("BootSequence called");const[e,n]=Q.useState(0),[i,r]=Q.useState(0),[s,o]=Q.useState(!0);return Q.useEffect(()=>{console.log("BootSequence effect started");const a=setInterval(()=>{n(c=>c<td.length-1?c+1:(clearInterval(a),c))},300),l=setInterval(()=>{r(c=>c>=100?(clearInterval(l),setTimeout(()=>{o(!1),setTimeout(t,800)},200),100):c+2.2)},40);return()=>{clearInterval(a),clearInterval(l)}},[t]),s?j.jsx(TM,{children:j.jsx(Ct.div,{initial:{opacity:1},exit:{opacity:0,scale:1.02},transition:{duration:.8},className:"fixed inset-0 z-[9999] bg-[#030306] flex items-center justify-center",style:{backgroundImage:"repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(0,212,255,0.03) 2px, rgba(0,212,255,0.03) 4px)"},children:j.jsxs("div",{className:"w-full max-w-2xl px-8",children:[j.jsx("div",{className:"space-y-4 mb-12",children:td.map((a,l)=>j.jsxs(Ct.div,{initial:{opacity:0,x:-8},animate:l<=e?{opacity:1,x:0}:{},transition:{duration:.3},className:"flex items-center justify-between font-mono text-sm",children:[j.jsxs("div",{className:"flex items-center gap-3",children:[j.jsx("span",{className:"text-gray-500",children:">"}),j.jsx("span",{className:"text-gray-400",children:a}),l===e&&l<td.length-1&&j.jsx(Ct.span,{animate:{opacity:[1,0,1]},transition:{duration:.8,repeat:1/0},className:"w-2 h-4 bg-[#00D4FF] inline-block"})]}),l<e&&j.jsx(Ct.span,{initial:{opacity:0},animate:{opacity:1},className:"text-green-500",children:"[OK]"})]},l))}),j.jsxs("div",{className:"relative",children:[j.jsx("div",{className:"h-1 bg-gray-800 rounded-full overflow-hidden",children:j.jsx(Ct.div,{initial:{width:"0%"},animate:{width:`${i}%`},className:"h-full bg-gradient-to-r from-[#0099cc] to-[#00D4FF] relative",children:j.jsx("div",{className:"absolute right-0 top-0 w-8 h-full bg-white opacity-60 blur-md"})})}),j.jsxs("div",{className:"flex justify-between mt-2 font-mono text-xs text-gray-500",children:[j.jsx("span",{children:"LOADING"}),j.jsxs("span",{children:[Math.floor(i),"%"]})]})]})]})})}):null}const Fx=["Engineer","Systems Architect","Game Developer"];function yN(){const[t,e]=Q.useState(0),[n,i]=Q.useState(""),[r,s]=Q.useState(!1);return Q.useEffect(()=>{const o=Fx[t],a=setTimeout(()=>{r?n.length>0?i(n.slice(0,-1)):(s(!1),e(l=>(l+1)%Fx.length)):n.length<o.length?i(o.slice(0,n.length+1)):setTimeout(()=>s(!0),2200)},r?35:75);return()=>clearTimeout(a)},[n,r,t]),j.jsxs("div",{className:"flex items-center gap-1",children:[j.jsx("span",{className:"text-gray-400",children:n}),j.jsx(Ct.span,{animate:{opacity:[1,0,1]},transition:{duration:.7,repeat:1/0},className:"w-0.5 h-6 bg-[#00D4FF] inline-block"})]})}const Ux=[{id:"home",label:"Home"},{id:"projects",label:"Projects"},{id:"skills",label:"Skills"},{id:"terminal",label:"Terminal"},{id:"contact",label:"Contact"}];function SN(){const[t,e]=Q.useState("home"),[n,i]=Q.useState(!1);Q.useEffect(()=>{setTimeout(()=>i(!0),500);const s=Ux.map(o=>{const a=document.getElementById(o.id);if(!a)return null;const l=new IntersectionObserver(([c])=>{c.isIntersecting&&e(o.id)},{threshold:.4});return l.observe(a),l});return()=>{s.forEach(o=>o==null?void 0:o.disconnect())}},[]);const r=s=>{const o=document.getElementById(s);o==null||o.scrollIntoView({behavior:"smooth"})};return j.jsx(Ct.nav,{initial:{y:-20,opacity:0},animate:n?{y:0,opacity:1}:{},className:"fixed top-8 left-1/2 -translate-x-1/2 z-50 backdrop-blur-[20px] rounded-full px-6 py-3",style:{backgroundColor:"rgba(5,5,8,0.85)"},children:j.jsx("ul",{className:"flex items-center gap-2",children:Ux.map(s=>j.jsxs("li",{className:"relative",children:[j.jsx("button",{onMouseDown:o=>o.preventDefault(),onClick:()=>r(s.id),className:`relative z-10 px-4 py-2 text-sm font-medium transition-colors ${t===s.id?"text-white":"text-gray-400 hover:text-gray-200"}`,children:s.label}),t===s.id&&j.jsx(Ct.div,{layoutId:"navpill",className:"absolute inset-0 rounded-full",style:{backgroundColor:"rgba(0,212,255,0.15)"},transition:{type:"spring",stiffness:300,damping:30}})]},s.id))})})}function MN({children:t,className:e="",style:n}){return j.jsx("div",{className:e,style:{...n,transform:"none",transition:"transform 0.3s ease"},children:t})}function EN({title:t,description:e,tech:n,index:i,videoId:r}){console.log(r);const s=Q.useRef(null),o=OM(s,{once:!0,margin:"-60px"});return j.jsx(Ct.div,{ref:s,initial:{opacity:0,y:50},animate:o?{opacity:1,y:0}:{},transition:{duration:.6,delay:i*.12},children:j.jsxs(MN,{disableTilt:!!r,className:"group relative overflow-hidden rounded-xl border border-white/5 bg-gradient-to-br from-white/[0.03] to-transparent transition-all duration-500 hover:border-[#00D4FF]/20 hover:shadow-[0_30px_80px_rgba(0,0,0,0.5),0_0_60px_rgba(0,212,255,0.06)]",style:{boxShadow:"0 8px 30px rgba(0,0,0,0.3)"},children:[j.jsx("div",{className:"absolute inset-0 pointer-events-none bg-gradient-to-br from-[#00D4FF]/0 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-5"}),r&&j.jsx("div",{className:"aspect-video w-full overflow-hidden",children:j.jsx("iframe",{className:"w-full h-full",src:`https://www.youtube.com/embed/${r}`,title:"Project video",frameBorder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",allowFullScreen:!0})}),j.jsxs("div",{className:"p-8",children:[j.jsx("h3",{className:"text-2xl font-bold text-white mb-3",children:t}),j.jsx("p",{className:"text-gray-400 mb-6 leading-relaxed",children:e}),j.jsx("div",{className:"flex flex-wrap gap-2",children:n.map(a=>j.jsx("span",{className:"px-3 py-1 text-xs font-mono rounded-full border border-[#00D4FF]/20 bg-[#00D4FF]/5 text-[#00D4FF]/50 transition-colors duration-300 group-hover:text-[#00D4FF]/90",children:a},a))})]})]})})}const Ox={help:()=>[{type:"output",content:"Available commands:"},{type:"output",content:"  help                  - Show this help message"},{type:"output",content:"  whoami                - Display user info"},{type:"output",content:"  terminal destroyers   - Initiate destruction protocol"},{type:"output",content:"  clear                 - Clear terminal"}],whoami:()=>[{type:"output",content:"ekrot@system-core"},{type:"output",content:"Roblox Systems Engineer"}],"terminal destroyers":()=>[{type:"output",content:"Initializing destruction protocol..."},{type:"output",content:"Bypassing neural safeguards..."},{type:"output",content:"Overriding system constraints..."},{type:"output",content:"Terminal override complete."},{type:"output",content:"You are now the destroyer."}]};function TN(){const[t,e]=Q.useState([{type:"system",content:"System Console v1.0 - Click to activate"}]),[n,i]=Q.useState(""),[r,s]=Q.useState([]),[o,a]=Q.useState(-1),[l,c]=Q.useState(!1),[f,h]=Q.useState(!1),u=Q.useRef(null),p=Q.useRef(null),g=Q.useRef(null);Q.useEffect(()=>{p.current&&(p.current.scrollTop=p.current.scrollHeight)},[t]),Q.useEffect(()=>{const d=m=>{var x;u.current&&!u.current.contains(m.target)&&(h(!1),(x=g.current)==null||x.blur())};return document.addEventListener("mousedown",d),()=>document.removeEventListener("mousedown",d)},[]),Q.useEffect(()=>{if(!u.current)return;const d=new IntersectionObserver(([m])=>{var x;m.isIntersecting||(h(!1),(x=g.current)==null||x.blur())},{threshold:.2});return d.observe(u.current),()=>d.disconnect()},[]);const y=async d=>{const m=d.trim().toLowerCase();m&&(e(x=>[...x,{type:"user",content:d}]),s(x=>[...x,d]),i(""),a(-1),c(!0),await new Promise(x=>setTimeout(x,400)),m==="clear"?e([{type:"system",content:"Terminal cleared."}]):Ox[m]?e(x=>[...x,...Ox[m]()]):e(x=>[...x,{type:"error",content:`Command not found: ${d}`}]),c(!1))},v=d=>{if(f){if(d.key==="Enter")y(n);else if(d.key==="ArrowUp"){if(d.preventDefault(),r.length>0){const m=o<r.length-1?o+1:o;a(m),i(r[r.length-1-m])}}else if(d.key==="ArrowDown")if(d.preventDefault(),o>0){const m=o-1;a(m),i(r[r.length-1-m])}else a(-1),i("")}};return j.jsxs("div",{ref:u,className:"bg-black/40 backdrop-blur-sm border border-white/10 rounded-lg overflow-hidden",onClick:()=>{var d;h(!0),(d=g.current)==null||d.focus()},children:[j.jsxs("div",{className:"flex items-center gap-2 px-4 py-3 bg-white/5 border-b border-white/10",children:[j.jsx("div",{className:"w-3 h-3 rounded-full bg-red-500"}),j.jsx("div",{className:"w-3 h-3 rounded-full bg-yellow-500"}),j.jsx("div",{className:"w-3 h-3 rounded-full bg-green-500"}),j.jsx("span",{className:"ml-2 text-xs text-gray-400 font-mono",children:"system-console"})]}),j.jsxs("div",{ref:p,className:"p-4 h-96 overflow-y-auto font-mono text-sm space-y-1",children:[j.jsx(TM,{children:t.map((d,m)=>j.jsxs(Ct.div,{initial:{opacity:0,x:-4},animate:{opacity:1,x:0},transition:{duration:.2},className:d.type==="system"?"text-gray-600":d.type==="user"?"text-white":d.type==="error"?"text-red-400":"text-[#7B61FF]",children:[d.type==="user"&&j.jsx("span",{className:"text-[#00D4FF]",children:"> "}),d.content]},m))}),!l&&j.jsxs("div",{className:"flex items-center gap-2",children:[j.jsx("span",{className:"text-[#00D4FF]",children:">"}),j.jsx("input",{ref:g,type:"text",value:n,onChange:d=>i(d.target.value),onKeyDown:v,className:"flex-1 bg-transparent outline-none text-white",tabIndex:-1}),f&&j.jsx(Ct.span,{animate:{opacity:[1,0,1]},transition:{duration:.7,repeat:1/0},className:"w-2 h-4 bg-[#00D4FF]"})]})]})]})}function $l({children:t,className:e="",as:n="button",href:i,onClick:r}){const s=Q.useRef(null),o=Q.useRef(0),a=Q.useRef(0),[l,c]=Q.useState(!1),u={ref:s,className:e,onMouseMove:p=>{if(!s.current)return;const g=s.current.getBoundingClientRect(),y=g.left+g.width/2,v=g.top+g.height/2,d=p.clientX-y,m=p.clientY-v,x=Math.sqrt(d*d+m*m),S=d/x*Math.min(x,50)*.2,E=m/x*Math.min(x,50)*.2;if(!l){c(!0);const A=()=>{o.current+=(S-o.current)*.12,a.current+=(E-a.current)*.12,s.current&&(s.current.style.transform=`translate(${o.current}px, ${a.current}px)`),Math.abs(S-o.current)>.5||Math.abs(E-a.current)>.5?requestAnimationFrame(A):c(!1)};A()}},onMouseLeave:()=>{const p=()=>{o.current*=.8,a.current*=.8,s.current&&(s.current.style.transform=`translate(${o.current}px, ${a.current}px)`),(Math.abs(o.current)>.1||Math.abs(a.current)>.1)&&requestAnimationFrame(p)};p()},style:{willChange:"transform"}};return n==="a"?j.jsx("a",{...u,href:i,children:t}):j.jsx("button",{...u,onClick:r,children:t})}function wN(){return j.jsxs(j.Fragment,{children:[j.jsx("div",{className:"fixed inset-0 z-[2] pointer-events-none opacity-[0.022]",style:{backgroundImage:`url("data:image/svg+xml,%3Csvg viewBox='0 0 256 256' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noise'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='4' /%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noise)' /%3E%3C/svg%3E")`}}),j.jsx("div",{className:"fixed inset-0 z-[2] pointer-events-none opacity-[0.04]",style:{backgroundImage:"repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(0,0,0,0.5) 2px, rgba(0,0,0,0.5) 4px)"}}),j.jsxs("div",{className:"fixed inset-0 z-0 pointer-events-none",children:[j.jsx("div",{className:"absolute top-0 left-0 w-[800px] h-[800px] rounded-full blur-[120px] opacity-20 animate-[breath_8s_ease-in-out_infinite]",style:{background:"radial-gradient(circle, #00D4FF 0%, transparent 70%)",animationDelay:"0s"}}),j.jsx("div",{className:"absolute bottom-0 right-0 w-[600px] h-[600px] rounded-full blur-[100px] opacity-15 animate-[breath_10s_ease-in-out_infinite]",style:{background:"radial-gradient(circle, #7B61FF 0%, transparent 70%)",animationDelay:"2s"}})]}),j.jsx("style",{children:`
        @keyframes breath {
          0%, 100% { transform: scale(1); }
          50% { transform: scale(1.1); }
        }
      `})]})}const AN=[{title:"Neural Rendering Engine",description:"Real-time volumetric rendering system using custom GLSL shaders and compute pipelines for procedural world generation.",tech:["WebGL","GLSL","Three.js","TypeScript"],videoId:"Ejbkd6h4Pss"},{title:"Distributed Task Orchestrator",description:"Microservices architecture handling 10M+ daily operations with event-driven design and advanced caching strategies.",tech:["Node.js","Redis","PostgreSQL","Docker"],videoId:"undefined"},{title:"Quantum State Visualizer",description:"Interactive data visualization platform for quantum computing simulations with real-time WebGL particle systems.",tech:["React","WebGL","D3.js","Python"],videoId:"undefined"},{title:"AI-Powered Code Assistant",description:"Machine learning model integration for intelligent code completion and refactoring suggestions in real-time.",tech:["Python","TensorFlow","FastAPI","WebSockets"],videoId:"undefined"}],CN=[{category:"Frontend",items:["React","TypeScript","Three.js","WebGL","Tailwind"]},{category:"Backend",items:["Node.js","Python","PostgreSQL","Redis","Docker"]},{category:"Graphics",items:["GLSL","Shaders","Blender","Unity","Unreal"]},{category:"Tools",items:["Git","CI/CD","AWS","Linux","Figma"]}];function RN(){const[t,e]=Q.useState(!1);Q.useEffect(()=>{t&&("scrollRestoration"in window.history&&(window.history.scrollRestoration="manual"),window.scrollTo(0,0))},[t]);const n=Q.useRef(0),i=Q.useRef(null),r=OM(i,{once:!0,margin:"-80px"});return Q.useEffect(()=>{const s=()=>{console.log("SCROLL Y:",window.scrollY)};return window.addEventListener("scroll",s),()=>window.removeEventListener("scroll",s)},[]),Q.useEffect(()=>{window.scrollTo(0,0)},[]),Q.useEffect(()=>{const s=()=>{const o=window.scrollY/(document.documentElement.scrollHeight-window.innerHeight);n.current=Math.min(Math.max(o,0),1)};return window.addEventListener("scroll",s),()=>window.removeEventListener("scroll",s)},[]),Q.useEffect(()=>(document.body.style.cursor="none",()=>{document.body.style.cursor="auto"}),[]),j.jsxs(j.Fragment,{children:[j.jsx(_N,{onComplete:()=>{console.log("🎯 setBooted(true) called"),e(!0)}}),t&&j.jsxs(Ct.div,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.8},children:[j.jsx(xN,{}),j.jsxs("div",{className:"relative bg-[#030306] text-white overflow-x-hidden",children:[j.jsx(eP,{}),j.jsx(vN,{scrollRef:n}),j.jsx(wN,{}),j.jsx(SN,{}),j.jsxs("div",{className:"relative z-10",children:[j.jsx("section",{id:"home",className:"min-h-screen flex items-center justify-center px-8",children:j.jsxs(Ct.div,{initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:1,delay:.2},className:"max-w-4xl text-center",children:[j.jsxs(Ct.div,{initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},transition:{duration:.8,delay:.4},className:"mb-6",children:[j.jsx("h1",{className:"text-7xl md:text-8xl font-bold mb-4 text-white",children:"Ekrots"}),j.jsx("div",{className:"text-2xl md:text-3xl",children:j.jsx(yN,{})})]}),j.jsx(Ct.p,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.8,delay:.8},className:"text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed",children:"Building immersive digital experiences at the intersection of code and cutting-edge technology. Specializing in programming.                  "})]})}),j.jsx("section",{id:"projects",className:"py-36 px-8",children:j.jsxs("div",{className:"max-w-6xl mx-auto",children:[j.jsxs(Ct.div,{initial:{opacity:0,y:50},whileInView:{opacity:1,y:0},viewport:{once:!0,margin:"-80px"},transition:{duration:.6},className:"mb-16",children:[j.jsxs("div",{className:"flex items-center gap-4 mb-4",children:[j.jsx("div",{className:"h-px flex-1 bg-gradient-to-r from-transparent to-[#00D4FF]"}),j.jsx("span",{className:"text-[#00D4FF] text-sm font-mono tracking-wider",children:"SELECTED WORK"})]}),j.jsx("h2",{className:"text-5xl font-bold",children:"Featured Projects"})]}),j.jsx("div",{className:"grid md:grid-cols-2 gap-8",children:AN.map((s,o)=>j.jsx(EN,{...s,index:o},o))})]})}),j.jsx("section",{id:"skills",className:"py-36 px-8",ref:i,children:j.jsxs("div",{className:"max-w-6xl mx-auto",children:[j.jsxs(Ct.div,{initial:{opacity:0,y:50},animate:r?{opacity:1,y:0}:{},transition:{duration:.6},className:"mb-16",children:[j.jsxs("div",{className:"flex items-center gap-4 mb-4",children:[j.jsx("div",{className:"h-px flex-1 bg-gradient-to-r from-transparent to-[#00D4FF]"}),j.jsx("span",{className:"text-[#00D4FF] text-sm font-mono tracking-wider",children:"EXPERTISE"})]}),j.jsx("h2",{className:"text-5xl font-bold",children:"Technical Skills"})]}),j.jsx("div",{className:"grid md:grid-cols-2 lg:grid-cols-4 gap-8",children:CN.map((s,o)=>j.jsxs(Ct.div,{initial:{opacity:0,y:30},animate:r?{opacity:1,y:0}:{},transition:{duration:.5,delay:o*.1},className:"p-6 rounded-lg border border-white/5 bg-white/[0.02]",children:[j.jsx("h3",{className:"text-xl font-bold mb-4 text-[#00D4FF]",children:s.category}),j.jsx("ul",{className:"space-y-2",children:s.items.map((a,l)=>j.jsxs("li",{className:"text-gray-400 flex items-center gap-2",children:[j.jsx("span",{className:"w-1.5 h-1.5 bg-[#00D4FF] rounded-full"}),a]},l))})]},o))})]})}),j.jsx("section",{id:"terminal",className:"py-36 px-8",children:j.jsxs("div",{className:"max-w-4xl mx-auto",children:[j.jsxs(Ct.div,{initial:{opacity:0,y:50},whileInView:{opacity:1,y:0},viewport:{once:!0,margin:"-80px"},transition:{duration:.6},className:"mb-16",children:[j.jsxs("div",{className:"flex items-center gap-4 mb-4",children:[j.jsx("div",{className:"h-px flex-1 bg-gradient-to-r from-transparent to-[#00D4FF]"}),j.jsx("span",{className:"text-[#00D4FF] text-sm font-mono tracking-wider",children:"INTERACTIVE"})]}),j.jsx("h2",{className:"text-5xl font-bold mb-4",children:"Neural Terminal"}),j.jsxs("p",{className:"text-gray-500",children:["Try out commands like ",j.jsx("code",{className:"text-[#00D4FF] font-mono",children:"help"}),","," ",j.jsx("code",{className:"text-[#00D4FF] font-mono",children:"whoami"}),", or"," ",j.jsx("code",{className:"text-[#00D4FF] font-mono",children:"clear"})]})]}),j.jsx(Ct.div,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0,margin:"-60px"},transition:{duration:.6,delay:.2},children:j.jsx(TN,{})})]})}),j.jsx("section",{id:"contact",className:"py-36 px-8",children:j.jsx("div",{className:"max-w-2xl mx-auto text-center",children:j.jsxs(Ct.div,{initial:{opacity:0,y:50},whileInView:{opacity:1,y:0},viewport:{once:!0,margin:"-80px"},transition:{duration:.6},children:[j.jsxs("div",{className:"flex items-center justify-center gap-4 mb-4",children:[j.jsx("div",{className:"h-px flex-1 bg-gradient-to-r from-transparent to-[#00D4FF]"}),j.jsx("span",{className:"text-[#00D4FF] text-sm font-mono tracking-wider",children:"GET IN TOUCH"}),j.jsx("div",{className:"h-px flex-1 bg-gradient-to-l from-transparent to-[#00D4FF]"})]}),j.jsx("h2",{className:"text-5xl font-bold mb-6",children:"Let's Build Something"}),j.jsx("p",{className:"text-gray-500 text-lg mb-12",children:"Open to collaboration on innovative projects. Whether it's cutting-edge web experiences, real-time graphics, or scalable systems architecture."}),j.jsxs("div",{className:"flex items-center justify-center gap-6 mb-12",children:[j.jsx($l,{as:"a",href:"https://github.com",className:"p-4 rounded-full border border-white/10 bg-white/5 hover:border-[#00D4FF]/30 transition-colors",children:j.jsx(qb,{size:24})}),j.jsx($l,{as:"a",href:"https://linkedin.com",className:"p-4 rounded-full border border-white/10 bg-white/5 hover:border-[#00D4FF]/30 transition-colors",children:j.jsx(Kb,{size:24})}),j.jsx($l,{as:"a",href:"mailto:alex@example.com",className:"p-4 rounded-full border border-white/10 bg-white/5 hover:border-[#00D4FF]/30 transition-colors",children:j.jsx(Zb,{size:24})})]}),j.jsx($l,{as:"a",href:"mailto:alex@example.com",className:"inline-block px-8 py-4 rounded-full bg-gradient-to-r from-[#0099cc] to-[#00D4FF] text-white font-semibold hover:shadow-[0_0_40px_rgba(0,212,255,0.3)] transition-shadow",children:"Start a Conversation"})]})})}),j.jsx("footer",{className:"py-8 px-8 border-t border-white/5",children:j.jsxs("div",{className:"max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4",children:[j.jsx("p",{className:"text-gray-600 text-sm font-mono",children:"Crafted with React, Three.js & GLSL"}),j.jsx("p",{className:"text-gray-700 text-sm"})]})})]})]})]})]})}"scrollRestoration"in window.history&&(window.history.scrollRestoration="manual");Ky(document.getElementById("root")).render(j.jsx(Q.StrictMode,{children:j.jsx(RN,{})}));
