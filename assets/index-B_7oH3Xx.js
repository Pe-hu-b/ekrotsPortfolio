...
`;function vN({scrollRef:t}){const e=Q.useRef(null),n=Q.useRef({x:0,y:0});return Q.useEffect(()=>{if(!e.current)return;const i=new QP;i.fog=new $m(0,.012);const r=new On(60,window.innerWidth/window.innerHeight,.1,1e3);r.position.z=35;const s=new pN({antialias:!Xo,alpha:!0});s.setPixelRatio(Math.min(window.devicePixelRatio,Xo?1:1.5)),s.setSize(window.innerWidth,window.innerHeight),s.toneMapping=Bm,s.toneMappingExposure=1.2,e.current.appendChild(s.domElement);const o=Xo?60:120,a=[],l=[];for(let B=0;B<o;B++){const D=8+Math.random()*16,U=Math.random()*Math.PI*2,G=Math.acos(2*Math.random()-1),$=D*Math.sin(G)*Math.cos(U),te=D*Math.sin(G)*Math.sin(U),ne=D*Math.cos(G),ge=new Zm(.1+Math.random()*.1,6,6),Ve=new ha({color:Math.random()>.3?54527:8086015,transparent:!0,opacity:.7}),We=new Rn(ge,Ve);We.position.set($,te,ne),We.userData.phase=Math.random()*Math.PI*2,i.add(We),a.push(We),l.push(new O((Math.random()-.5)*.02,(Math.random()-.5)*.02,(Math.random()-.5)*.02))}const c=new iu(2.5,2),f=new ci({vertexShader:mN,fragmentShader:gN,uniforms:{uTime:{value:0},uColorBase:{value:new qe(35801)},uColorFresnel:{value:new qe(8086015)}},transparent:!0,blending:da,depthWrite:!1}),d=new Rn(c,f);i.add(d);const u=new iu(2.6,2),p=new ha({color:8086015,wireframe:!0,transparent:!0,opacity:.08}),g=new Rn(u,p);i.add(g);const _=new Qm(12,.04,4,80),v=new ha({color:8086015,transparent:!0,opacity:.12}),h=new Rn(_,v);h.rotation.x=Math.PI/3,i.add(h);const m=Xo?200:500,x=new on,S=new Float32Array(m*3);for(let B=0;B<m*3;B+=3)S[B]=(Math.random()-.5)*80,S[B+1]=(Math.random()-.5)*80,S[B+2]=(Math.random()-.5)*80;x.setAttribute("position",new ai(S,3));const E=new aE({color:8086015,size:.07,transparent:!0,opacity:.35,blending:da}),A=new u3(x,E);i.add(A);let C=null;const y=Xo?9:7;let T=0;const L=()=>{C&&i.remove(C);const B=[],D=[];for(let $=0;$<a.length;$++)for(let te=$+1;te<a.length;te++){const ne=a[$].position.distanceTo(a[te].position);if(ne<y){B.push(a[$].position.x,a[$].position.y,a[$].position.z,a[te].position.x,a[te].position.y,a[te].position.z);const ge=.1*(1-ne/y);D.push(0,.831,1,ge),D.push(0,.831,1,ge)}}const U=new on;U.setAttribute("position",new Tt(B,3)),U.setAttribute("color",new Tt(D,4));const G=new oE({vertexColors:!0,transparent:!0,blending:da});C=new c3(U,G),i.add(C)},b=B=>{n.current.x=B.clientX/window.innerWidth*2-1,n.current.y=-(B.clientY/window.innerHeight)*2+1};window.addEventListener("mousemove",b);const k=()=>{r.aspect=window.innerWidth/window.innerHeight,r.updateProjectionMatrix(),s.setSize(window.innerWidth,window.innerHeight)};window.addEventListener("resize",k);const V={x:0,y:0,z:35};let Y=0;const H=()=>{Y+=.016,T++,f.uniforms.uTime.value=Y,a.forEach((ge,Ve)=>{ge.position.add(l[Ve]),Math.abs(ge.position.x)>25&&(l[Ve].x*=-1),Math.abs(ge.position.y)>20&&(l[Ve].y*=-1),Math.abs(ge.position.z)>20&&(l[Ve].z*=-1);const We=.5+.5*Math.sin(Y*1.5+ge.userData.phase);ge.material.opacity=.4+.6*We,ge.scale.setScalar(.85+.3*We)}),T%4===0&&L(),h.rotation.z+=.004;const B=x.attributes.position.array;for(let ge=1;ge<B.length;ge+=3)B[ge]+=.0015;for(let ge=0;ge<B.length;ge+=3)B[ge]+=4e-4;x.attributes.position.needsUpdate=!0;const D=t.current,U=35-D*20,G=D*8,$=Math.sin(D*Math.PI)*5,te=n.current.x*3,ne=n.current.y*2;V.x+=($+te-V.x)*.04,V.y+=(G+ne-V.y)*.04,V.z+=(U-V.z)*.04,r.position.set(V.x,V.y,V.z),r.lookAt(0,G*.3,0),s.render(i,r),requestAnimationFrame(H)};return H(),()=>{var B;window.removeEventListener("mousemove",b),window.removeEventListener("resize",k),(B=e.current)==null||B.removeChild(s.domElement),s.dispose()}},[t]),X.jsx("div",{ref:e,className:"fixed inset-0 z-[1]"})}function xN(){const t=Q.useRef(null),e=Q.useRef(null),n=Q.useRef({x:0,y:0}),i=Q.useRef({x:0,y:0});return Q.useEffect(()=>{const r=o=>{i.current={x:o.clientX,y:o.clientY},t.current&&(t.current.style.transform=`translate(${o.clientX-3}px, ${o.clientY-3}px)`)},s=()=>{n.current.x+=(i.current.x-n.current.x)*.12,n.current.y+=(i.current.y-n.current.y)*.12,e.current&&(e.current.style.transform=`translate(${n.current.x-16}px, ${n.current.y-16}px)`),requestAnimationFrame(s)};return window.addEventListener("mousemove",r),s(),()=>{window.removeEventListener("mousemove",r)}},[]),X.jsxs(X.Fragment,{children:[X.jsx("div",{ref:t,className:"fixed top-0 left-0 w-[6px] h-[6px] rounded-full pointer-events-none z-[9999] mix-blend-difference",style:{backgroundColor:"#00D4FF",willChange:"transform"}}),X.jsx("div",{ref:e,className:"fixed top-0 left-0 w-8 h-8 rounded-full pointer-events-none z-[9999] border border-[rgba(0,212,255,0.4)]",style:{willChange:"transform"}})]})}const td=["INITIALIZING NEURAL CORE...","LOADING QUANTUM PROCESSORS...","ESTABLISHING BLOCKCHAIN NODES...","SYNCING DISTRIBUTED SYSTEMS...","ACTIVATING PORTFOLIO INTERFACE..."];function _N({onComplete:t}){const[e,n]=Q.useState(0),[i,r]=Q.useState(0),[s,o]=Q.useState(!0);return Q.useEffect(()=>{if(sessionStorage.getItem("portfolio_booted_v3")){t(),o(!1);return}const l=setInterval(()=>{n(f=>f<td.length-1?f+1:(clearInterval(l),f))},300),c=setInterval(()=>{r(f=>f>=100?(clearInterval(c),setTimeout(()=>{sessionStorage.setItem("portfolio_booted_v3","true"),o(!1),setTimeout(t,800)},200),100):f+2.2)},40);return()=>{clearInterval(l),clearInterval(c)}},[t]),s?X.jsx(TM,{children:X.jsx(Lt.div,{initial:{opacity:1},exit:{opacity:0,scale:1.02},transition:{duration:.8},className:"fixed inset-0 z-[9999] bg-[#030306] flex items-center justify-center",style:{backgroundImage:"repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(0,212,255,0.03) 2px, rgba(0,212,255,0.03) 4px)"},children:X.jsxs("div",{className:"w-full max-w-2xl px-8",children:[X.jsx("div",{className:"space-y-4 mb-12",children:td.map((a,l)=>X.jsxs(Lt.div,{initial:{opacity:0,x:-8},animate:l<=e?{opacity:1,x:0}:{},transition:{duration:.3},className:"flex items-center justify-between font-mono text-sm",children:[X.jsxs("div",{className:"flex items-center gap-3",children:[X.jsx("span",{className:"text-gray-500",children:">"}),X.jsx("span",{className:"text-gray-400",children:a}),l===e&&l<td.length-1&&X.jsx(Lt.span,{animate:{opacity:[1,0,1]},transition:{duration:.8,repeat:1/0},className:"w-2 h-4 bg-[#00D4FF] inline-block"})]}),l<e&&X.jsx(Lt.span,{initial:{opacity:0},animate:{opacity:1},className:"text-green-500",children:"[OK]"})]},l))}),X.jsxs("div",{className:"relative",children:[X.jsx("div",{className:"h-1 bg-gray-800 rounded-full overflow-hidden",children:X.jsx(Lt.div,{initial:{width:"0%"},animate:{width:`${i}%`},className:"h-full bg-gradient-to-r from-[#0099cc] to-[#00D4FF] relative",children:X.jsx("div",{className:"absolute right-0 top-0 w-8 h-full bg-white opacity-60 blur-md"})})}),X.jsxs("div",{className:"flex justify-between mt-2 font-mono text-xs text-gray-500",children:[X.jsx("span",{children:"LOADING"}),X.jsxs("span",{children:[Math.floor(i),"%"]})]})]})]})})}):null}const Fx=["Full-Stack Engineer","Systems Architect","Game Developer","Graphics Programmer","Creative Technologist"];function yN(){const[t,e]=Q.useState(0),[n,i]=Q.useState(""),[r,s]=Q.useState(!1);return Q.useEffect(()=>{const o=Fx[t],a=setTimeout(()=>{r?n.length>0?i(n.slice(0,-1)):(s(!1),e(l=>(l+1)%Fx.length)):n.length<o.length?i(o.slice(0,n.length+1)):setTimeout(()=>s(!0),2200)},r?35:75);return()=>clearTimeout(a)},[n,r,t]),X.jsxs("div",{className:"flex items-center gap-1",children:[X.jsx("span",{className:"text-gray-400",children:n}),X.jsx(Lt.span,{animate:{opacity:[1,0,1]},transition:{duration:.7,repeat:1/0},className:"w-0.5 h-6 bg-[#00D4FF] inline-block"})]})}const Ux=[{id:"home",label:"Home"},{id:"projects",label:"Projects"},{id:"skills",label:"Skills"},{id:"terminal",label:"Terminal"},{id:"contact",label:"Contact"}];function SN(){const[t,e]=Q.useState("home"),[n,i]=Q.useState(!1);Q.useEffect(()=>{setTimeout(()=>i(!0),500);const s=Ux.map(o=>{const a=document.getElementById(o.id);if(!a)return null;const l=new IntersectionObserver(([c])=>{c.isIntersecting&&e(o.id)},{threshold:.4});return l.observe(a),l});return()=>{s.forEach(o=>o==null?void 0:o.disconnect())}},[]);const r=s=>{const o=document.getElementById(s);o==null||o.scrollIntoView({behavior:"smooth"})};return X.jsx(Lt.nav,{initial:{y:-20,opacity:0},animate:n?{y:0,opacity:1}:{},className:"fixed top-8 left-1/2 -translate-x-1/2 z-50 backdrop-blur-[20px] rounded-full px-6 py-3",style:{backgroundColor:"rgba(5,5,8,0.85)"},children:X.jsx("ul",{className:"flex items-center gap-2",children:Ux.map(s=>X.jsxs("li",{className:"relative",children:[X.jsx("button",{onClick:()=>r(s.id),className:`relative z-10 px-4 py-2 text-sm font-medium transition-colors ${t===s.id?"text-white":"text-gray-400 hover:text-gray-200"}`,children:s.label}),t===s.id&&X.jsx(Lt.div,{layoutId:"navpill",className:"absolute inset-0 rounded-full",style:{backgroundColor:"rgba(0,212,255,0.15)"},transition:{type:"spring",stiffness:300,damping:30}})]},s.id))})})}function MN({children:t,className:e="",style:n}){const i=Q.useRef(null),r=Q.useRef(0),s=Q.useRef(0),o=Q.useRef(0),a=Q.useRef(0),[l,c]=Q.useState(!1),f=u=>{if(!i.current)return;const p=i.current.getBoundingClientRect(),g=(u.clientX-p.left)/p.width-.5,_=(u.clientY-p.top)/p.height-.5;if(a.current=g*12,o.current=-_*12,!l){c(!0);const v=()=>{r.current+=(o.current-r.current)*.1,s.current+=(a.current-s.current)*.1,i.current&&(i.current.style.transform=`perspective(1000px) rotateX(${r.current}deg) rotateY(${s.current}deg)`),Math.abs(o.current-r.current)>.1||Math.abs(a.current-s.current)>.1?requestAnimationFrame(v):c(!1)};v()}},d=()=>{o.current=0,a.current=0;const u=()=>{r.current*=.85,s.current*=.85,i.current&&(i.current.style.transform=`perspective(1000px) rotateX(${r.current}deg) rotateY(${s.current}deg)`),(Math.abs(r.current)>.01||Math.abs(s.current)>.01)&&requestAnimationFrame(u)};u()};return X.jsx("div",{ref:i,onMouseMove:f,onMouseLeave:d,className:e,style:{...n,transition:"none"},children:t})}function EN({title:t,description:e,tech:n,index:i}){const r=Q.useRef(null),s=OM(r,{once:!0,margin:"-60px"});return X.jsx(Lt.div,{ref:r,initial:{opacity:0,y:50},animate:s?{opacity:1,y:0}:{},transition:{duration:.6,delay:i*.12},children:X.jsxs(MN,{className:"group relative overflow-hidden rounded-xl border border-white/5 bg-gradient-to-br from-white/[0.03] to-transparent p-8 transition-all duration-500 hover:border-[#00D4FF]/20 hover:shadow-[0_30px_80px_rgba(0,0,0,0.5),0_0_60px_rgba(0,212,255,0.06)]",style:{boxShadow:"0 8px 30px rgba(0,0,0,0.3)"},children:[X.jsx("div",{className:"absolute inset-0 bg-gradient-to-br from-[#00D4FF]/0 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-5"}),X.jsx("h3",{className:"text-2xl font-bold text-white mb-3",children:t}),X.jsx("p",{className:"text-gray-400 mb-6 leading-relaxed",children:e}),X.jsx("div",{className:"flex flex-wrap gap-2",children:n.map(o=>X.jsx("span",{className:"px-3 py-1 text-xs font-mono rounded-full border border-[#00D4FF]/20 bg-[#00D4FF]/5 text-[#00D4FF]/50 transition-colors duration-300 group-hover:text-[#00D4FF]/90",children:o},o))})]})})}const Ox={help:()=>[{type:"output",content:"Available commands:"},{type:"output",content:"  help                  - Show this help message"},{type:"output",content:"  whoami                - Display user info"},{type:"output",content:"  terminal destroyers   - Initiate destruction protocol"},{type:"output",content:"  clear                 - Clear terminal"}],whoami:()=>[{type:"output",content:"ekrot@system-core"},{type:"output",content:"Roblox Systems Engineer"}],"terminal destroyers":()=>[{type:"output",content:"Initializing destruction protocol..."},{type:"output",content:"Bypassing neural safeguards..."},{type:"output",content:"Overriding system constraints..."},{type:"output",content:"Terminal override complete."},{type:"output",content:"You are now the destroyer."}]};function TN(){const[t,e]=Q.useState([{type:"system",content:'System Console v1.0 - Type "help" for commands'}]),[n,i]=Q.useState(""),[r,s]=Q.useState([]),[o,a]=Q.useState(-1),[l,c]=Q.useState(!1),f=Q.useRef(null),d=Q.useRef(null);Q.useEffect(()=>{f.current&&(f.current.scrollTop=f.current.scrollHeight)},[t]);const u=async g=>{const _=g.trim().toLowerCase();_&&(e(v=>[...v,{type:"user",content:g}]),s(v=>[...v,g]),i(""),a(-1),c(!0),await new Promise(v=>setTimeout(v,400)),_==="clear"?e([{type:"system",content:"Terminal cleared."}]):Ox[_]?e(v=>[...v,...Ox[_]()]):e(v=>[...v,{type:"error",content:`Command not found: ${g}. Type "help" for available commands.`}]),c(!1))},p=g=>{if(g.key==="Enter")u(n);else if(g.key==="ArrowUp"){if(g.preventDefault(),r.length>0){const _=o<r.length-1?o+1:o;a(_),i(r[r.length-1-_])}}else if(g.key==="ArrowDown")if(g.preventDefault(),o>0){const _=o-1;a(_),i(r[r.length-1-_])}else a(-1),i("")};return X.jsxs("div",{className:"bg-black/40 backdrop-blur-sm border border-white/10 rounded-lg overflow-hidden",onClick:()=>{var g;return(g=d.current)==null?void 0:g.focus()},children:[X.jsxs("div",{className:"flex items-center gap-2 px-4 py-3 bg-white/5 border-b border-white/10",children:[X.jsx("div",{className:"w-3 h-3 rounded-full bg-red-500"}),X.jsx("div",{className:"w-3 h-3 rounded-full bg-yellow-500"}),X.jsx("div",{className:"w-3 h-3 rounded-full bg-green-500"}),X.jsx("span",{className:"ml-2 text-xs text-gray-400 font-mono",children:"system-console"})]}),X.jsxs("div",{ref:f,className:"p-4 h-96 overflow-y-auto font-mono text-sm space-y-1",children:[X.jsx(TM,{children:t.map((g,_)=>X.jsxs(Lt.div,{initial:{opacity:0,x:-4},animate:{opacity:1,x:0},transition:{duration:.2},className:g.type==="system"?"text-gray-600":g.type==="user"?"text-white":g.type==="error"?"text-red-400":"text-[#7B61FF]",children:[g.type==="user"&&X.jsx("span",{className:"text-[#00D4FF]",children:"> "}),g.content]},_))}),!l&&X.jsxs("div",{className:"flex items-center gap-2",children:[X.jsx("span",{className:"text-[#00D4FF]",children:">"}),X.jsx("input",{ref:d,type:"text",value:n,onChange:g=>i(g.target.value),onKeyDown:p,className:"flex-1 bg-transparent outline-none text-white",autoFocus:!0}),X.jsx(Lt.span,{animate:{opacity:[1,0,1]},transition:{duration:.7,repeat:1/0},className:"w-2 h-4 bg-[#00D4FF]"})]})]})]})}function $l({children:t,className:e="",as:n="button",href:i,onClick:r}){const s=Q.useRef(null),o=Q.useRef(0),a=Q.useRef(0),[l,c]=Q.useState(!1),u={ref:s,className:e,onMouseMove:p=>{if(!s.current)return;const g=s.current.getBoundingClientRect(),_=g.left+g.width/2,v=g.top+g.height/2,h=p.clientX-_,m=p.clientY-v,x=Math.sqrt(h*h+m*m),S=h/x*Math.min(x,50)*.2,E=m/x*Math.min(x,50)*.2;if(!l){c(!0);const A=()=>{o.current+=(S-o.current)*.12,a.current+=(E-a.current)*.12,s.current&&(s.current.style.transform=`translate(${o.current}px, ${a.current}px)`),Math.abs(S-o.current)>.5||Math.abs(E-a.current)>.5?requestAnimationFrame(A):c(!1)};A()}},onMouseLeave:()=>{const p=()=>{o.current*=.8,a.current*=.8,s.current&&(s.current.style.transform=`translate(${o.current}px, ${a.current}px)`),(Math.abs(o.current)>.1||Math.abs(a.current)>.1)&&requestAnimationFrame(p)};p()},style:{willChange:"transform"}};return n==="a"?X.jsx("a",{...u,href:i,children:t}):X.jsx("button",{...u,onClick:r,children:t})}function wN(){return X.jsxs(X.Fragment,{children:[X.jsx("div",{className:"fixed inset-0 z-[2] pointer-events-none opacity-[0.022]",style:{backgroundImage:`url("data:image/svg+xml,%3Csvg viewBox='0 0 256 256' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noise'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='4' /%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noise)' /%3E%3C/svg%3E")`}}),X.jsx("div",{className:"fixed inset-0 z-[2] pointer-events-none opacity-[0.04]",style:{backgroundImage:"repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(0,0,0,0.5) 2px, rgba(0,0,0,0.5) 4px)"}}),X.jsxs("div",{className:"fixed inset-0 z-0 pointer-events-none",children:[X.jsx("div",{className:"absolute top-0 left-0 w-[800px] h-[800px] rounded-full blur-[120px] opacity-20 animate-[breath_8s_ease-in-out_infinite]",style:{background:"radial-gradient(circle, #00D4FF 0%, transparent 70%)",animationDelay:"0s"}}),X.jsx("div",{className:"absolute bottom-0 right-0 w-[600px] h-[600px] rounded-full blur-[100px] opacity-15 animate-[breath_10s_ease-in-out_infinite]",style:{background:"radial-gradient(circle, #7B61FF 0%, transparent 70%)",animationDelay:"2s"}})]}),X.jsx("style",{children:`
        @keyframes breath {
          0%, 100% { transform: scale(1); }
          50% { transform: scale(1.1); }
        }
      `})]})}const AN=[{title:"Neural Rendering Engine",description:"Real-time volumetric rendering system using custom GLSL shaders and compute pipelines for procedural world generation.",tech:["WebGL","GLSL","Three.js","TypeScript"]},{title:"Distributed Task Orchestrator",description:"Microservices architecture handling 10M+ daily operations with event-driven design and advanced caching strategies.",tech:["Node.js","Redis","PostgreSQL","Docker"]},{title:"Quantum State Visualizer",description:"Interactive data visualization platform for quantum computing simulations with real-time WebGL particle systems.",tech:["React","WebGL","D3.js","Python"]},{title:"AI-Powered Code Assistant",description:"Machine learning model integration for intelligent code completion and refactoring suggestions in real-time.",tech:["Python","TensorFlow","FastAPI","WebSockets"]}],CN=[{category:"Frontend",items:["React","TypeScript","Three.js","WebGL","Tailwind"]},{category:"Backend",items:["Node.js","Python","PostgreSQL","Redis","Docker"]},{category:"Graphics",items:["GLSL","Shaders","Blender","Unity","Unreal"]},{category:"Tools",items:["Git","CI/CD","AWS","Linux","Figma"]}];function RN(){const[t,e]=Q.useState(!1),n=Q.useRef(0),i=Q.useRef(null),r=OM(i,{once:!0,margin:"-80px"});return Q.useEffect(()=>{const s=()=>{const o=window.scrollY/(document.documentElement.scrollHeight-window.innerHeight);n.current=Math.min(Math.max(o,0),1)};return window.addEventListener("scroll",s),()=>window.removeEventListener("scroll",s)},[]),Q.useEffect(()=>(document.body.style.cursor="none",()=>{document.body.style.cursor="auto"}),[]),X.jsxs(X.Fragment,{children:[X.jsx(_N,{onComplete:()=>e(!0)}),t&&X.jsxs(X.Fragment,{children:[X.jsx(xN,{}),X.jsxs("div",{className:"relative bg-[#030306] text-white overflow-x-hidden",children:[X.jsx(eP,{}),X.jsx(vN,{scrollRef:n}),X.jsx(wN,{}),X.jsx(SN,{}),X.jsxs("div",{className:"relative z-10",children:[X.jsx("section",{id:"home",className:"min-h-screen flex items-center justify-center px-8",children:X.jsxs(Lt.div,{initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:1,delay:.2},className:"max-w-4xl text-center",children:[X.jsxs(Lt.div,{initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},transition:{duration:.8,delay:.4},className:"mb-6",children:[X.jsx("h1",{className:"text-7xl md:text-8xl font-bold mb-4 text-white",children:"Alex Chen"}),X.jsx("div",{className:"text-2xl md:text-3xl",children:X.jsx(yN,{})})]}),X.jsx(Lt.p,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.8,delay:.8},className:"text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed",children:"Building immersive digital experiences at the intersection of code, design, and cutting-edge technology. Specializing in real-time graphics, distributed systems, and performant web applications."})]})}),X.jsx("section",{id:"projects",className:"py-36 px-8",children:X.jsxs("div",{className:"max-w-6xl mx-auto",children:[X.jsxs(Lt.div,{initial:{opacity:0,y:50},whileInView:{opacity:1,y:0},viewport:{once:!0,margin:"-80px"},transition:{duration:.6},className:"mb-16",children:[X.jsxs("div",{className:"flex items-center gap-4 mb-4",children:[X.jsx("div",{className:"h-px flex-1 bg-gradient-to-r from-transparent to-[#00D4FF]"}),X.jsx("span",{className:"text-[#00D4FF] text-sm font-mono tracking-wider",children:"SELECTED WORK"})]}),X.jsx("h2",{className:"text-5xl font-bold",children:"Featured Projects"})]}),X.jsx("div",{className:"grid md:grid-cols-2 gap-8",children:AN.map((s,o)=>X.jsx(EN,{...s,index:o},o))})]})}),X.jsx("section",{id:"skills",className:"py-36 px-8",ref:i,children:X.jsxs("div",{className:"max-w-6xl mx-auto",children:[X.jsxs(Lt.div,{initial:{opacity:0,y:50},animate:r?{opacity:1,y:0}:{},transition:{duration:.6},className:"mb-16",children:[X.jsxs("div",{className:"flex items-center gap-4 mb-4",children:[X.jsx("div",{className:"h-px flex-1 bg-gradient-to-r from-transparent to-[#00D4FF]"}),X.jsx("span",{className:"text-[#00D4FF] text-sm font-mono tracking-wider",children:"EXPERTISE"})]}),X.jsx("h2",{className:"text-5xl font-bold",children:"Technical Skills"})]}),X.jsx("div",{className:"grid md:grid-cols-2 lg:grid-cols-4 gap-8",children:CN.map((s,o)=>X.jsxs(Lt.div,{initial:{opacity:0,y:30},animate:r?{opacity:1,y:0}:{},transition:{duration:.5,delay:o*.1},className:"p-6 rounded-lg border border-white/5 bg-white/[0.02]",children:[X.jsx("h3",{className:"text-xl font-bold mb-4 text-[#00D4FF]",children:s.category}),X.jsx("ul",{className:"space-y-2",children:s.items.map((a,l)=>X.jsxs("li",{className:"text-gray-400 flex items-center gap-2",children:[X.jsx("span",{className:"w-1.5 h-1.5 bg-[#00D4FF] rounded-full"}),a]},l))})]},o))})]})}),X.jsx("section",{id:"terminal",className:"py-36 px-8",children:X.jsxs("div",{className:"max-w-4xl mx-auto",children:[X.jsxs(Lt.div,{initial:{opacity:0,y:50},whileInView:{opacity:1,y:0},viewport:{once:!0,margin:"-80px"},transition:{duration:.6},className:"mb-16",children:[X.jsxs("div",{className:"flex items-center gap-4 mb-4",children:[X.jsx("div",{className:"h-px flex-1 bg-gradient-to-r from-transparent to-[#00D4FF]"}),X.jsx("span",{className:"text-[#00D4FF] text-sm font-mono tracking-wider",children:"INTERACTIVE"})]}),X.jsx("h2",{className:"text-5xl font-bold mb-4",children:"Neural Terminal"}),X.jsxs("p",{className:"text-gray-500",children:["Try out commands like ",X.jsx("code",{className:"text-[#00D4FF] font-mono",children:"help"}),","," ",X.jsx("code",{className:"text-[#00D4FF] font-mono",children:"show skills"}),", or"," ",X.jsx("code",{className:"text-[#00D4FF] font-mono",children:"run project"})]})]}),X.jsx(Lt.div,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0,margin:"-60px"},transition:{duration:.6,delay:.2},children:X.jsx(TN,{})})]})}),X.jsx("section",{id:"contact",className:"py-36 px-8",children:X.jsx("div",{className:"max-w-2xl mx-auto text-center",children:X.jsxs(Lt.div,{initial:{opacity:0,y:50},whileInView:{opacity:1,y:0},viewport:{once:!0,margin:"-80px"},transition:{duration:.6},children:[X.jsxs("div",{className:"flex items-center justify-center gap-4 mb-4",children:[X.jsx("div",{className:"h-px flex-1 bg-gradient-to-r from-transparent to-[#00D4FF]"}),X.jsx("span",{className:"text-[#00D4FF] text-sm font-mono tracking-wider",children:"GET IN TOUCH"}),X.jsx("div",{className:"h-px flex-1 bg-gradient-to-l from-transparent to-[#00D4FF]"})]}),X.jsx("h2",{className:"text-5xl font-bold mb-6",children:"Let's Build Something"}),X.jsx("p",{className:"text-gray-500 text-lg mb-12",children:"Open to collaboration on innovative projects. Whether it's cutting-edge web experiences, real-time graphics, or scalable systems architecture."}),X.jsxs("div",{className:"flex items-center justify-center gap-6 mb-12",children:[X.jsx($l,{as:"a",href:"https://github.com",className:"p-4 rounded-full border border-white/10 bg-white/5 hover:border-[#00D4FF]/30 transition-colors",children:X.jsx(qb,{size:24})}),X.jsx($l,{as:"a",href:"https://linkedin.com",className:"p-4 rounded-full border border-white/10 bg-white/5 hover:border-[#00D4FF]/30 transition-colors",children:X.jsx(Kb,{size:24})}),X.jsx($l,{as:"a",href:"mailto:alex@example.com",className:"p-4 rounded-full border border-white/10 bg-white/5 hover:border-[#00D4FF]/30 transition-colors",children:X.jsx(Zb,{size:24})})]}),X.jsx($l,{as:"a",href:"mailto:alex@example.com",className:"inline-block px-8 py-4 rounded-full bg-gradient-to-r from-[#0099cc] to-[#00D4FF] text-white font-semibold hover:shadow-[0_0_40px_rgba(0,212,255,0.3)] transition-shadow",children:"Start a Conversation"})]})})}),X.jsx("footer",{className:"py-8 px-8 border-t border-white/5",children:X.jsxs("div",{className:"max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4",children:[X.jsx("p",{className:"text-gray-600 text-sm font-mono",children:"Crafted with React, Three.js & GLSL"}),X.jsx("p",{className:"text-gray-700 text-sm",children:"© 2024 Alex Chen. All rights reserved."})]})})]})]})]})]})}Ky(document.getElementById("root")).render(X.jsx(Q.StrictMode,{children:X.jsx(RN,{})}));
