...
export default function ProjectCard({ title, description, tech, index }: ProjectCardProps) {
  ...
  return (
    ...
    >
      <SpringTiltCard className="group relative overflow-hidden rounded-xl border border-white/5 bg-gradient-to-br from-white/[0.03] to-transparent p-8 transition-all duration-500 hover:border-[#00D4FF]/20 hover:shadow-[0_30px_80px_rgba(0,0,0,0.5),0_0_60px_rgba(0,212,255,0.06)]"
        style={{
